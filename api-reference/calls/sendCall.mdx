...
<ParamField body="start_node_id" type="string">
    This is the node ID for the node you want the pathway to start from. You can access the ID of your nodes [here](https://docs.malakai.ai/api-reference/pathways/get)
