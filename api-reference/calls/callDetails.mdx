...
<ResponseField name="endpoint_url" type="string">
  ...
  "api.prod.malakai.ai" unless the call was handled on a custom Enterprise
  deployment.
</ResponseField>
...
<ResponseField name="call_ended_by" type="string">
    Whether the call was ended by malakai’s system or the other end of the line.
...
```json Response
{
    ...
    "endpoint_url": "api.prod.malakai.ai",
    "max_duration": 30,
    "error_message": null,
    "variables": {
