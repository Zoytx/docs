...
<ResponseField name="endpoint_url" type="string">
  ...
  "api.prod.luly.ai" unless the call was handled on a custom Enterprise
  deployment.
</ResponseField>
...
<ResponseField name="call_ended_by" type="string">
    Whether the call was ended by Luly’s system or the other end of the line.
