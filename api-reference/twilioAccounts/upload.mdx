...
description: Add inbound numbers to Luly from your own Twilio account. See [Enterprise Twilio Integration](https://docs.luly.ai/enterprise-features/custom-twilio) for more information.
---
