...
description: Disable an encrypted key for a Twilio account integration. See [Enterprise Twilio Integration](https://docs.luly.ai/enterprise-features/custom-twilio) for more information.
---
